...
This unified plan combines the security initiatives below into a single, ordered project. All original content is preserved verbatim, just grouped into one file for coordinated implementation.

--------------------------------------------------------------------------------

Step 0: Client Version Enforcement (Low-Hanging Fruit Prerequisite)
===================================================================
