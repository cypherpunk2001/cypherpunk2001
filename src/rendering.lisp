...
(defun draw-menu (ui audio editor)
  ...
  (let* ((mouse-x (raylib:get-mouse-x))
         ...
         (hover-save (point-in-rect-p mouse-x mouse-y
                                      (ui-menu-save-x ui)
                                      (ui-menu-save-y ui)
                                      (ui-menu-nav-button-width ui)
                                      (ui-menu-nav-button-height ui)))
         (hover-load (point-in-rect-p mouse-x mouse-y
                                      (ui-menu-load-x ui)
                                      (ui-menu-load-y ui)
                                      (ui-menu-nav-button-width ui)
                                      (ui-menu-nav-button-height ui)))
         ...
         (vol-up-color (if hover-vol-up
                           (ui-menu-button-hover-color ui)
                           (ui-menu-button-color ui)))
         (save-color (if hover-save
                         (ui-menu-button-hover-color ui)
                         (ui-menu-button-color ui)))
         (load-color (if hover-load
                         (ui-menu-button-hover-color ui)
                         (ui-menu-button-color ui)))
    ...
    (raylib:draw-text (ui-menu-fullscreen-label ui)
                      ...
                      (ui-menu-volume-text-size ui)
                      (ui-menu-text-color ui))
    (raylib:draw-rectangle (ui-menu-load-x ui) (ui-menu-load-y ui)
                           (ui-menu-nav-button-width ui)
                           (ui-menu-nav-button-height ui)
                           load-color)
    (raylib:draw-text (ui-menu-load-label ui)
                      (+ (ui-menu-load-x ui) 18)
                      (+ (ui-menu-load-y ui) 12)
                      (ui-menu-nav-text-size ui)
                      (ui-menu-text-color ui))
    (raylib:draw-rectangle (ui-menu-save-x ui) (ui-menu-save-y ui)
                           (ui-menu-nav-button-width ui)
                           (ui-menu-nav-button-height ui)
                           save-color)
    (raylib:draw-text (ui-menu-save-label ui)
                      (+ (ui-menu-save-x ui) 18)
                      (+ (ui-menu-save-y ui) 12)
                      (ui-menu-nav-text-size ui)
                      (ui-menu-text-color ui))
